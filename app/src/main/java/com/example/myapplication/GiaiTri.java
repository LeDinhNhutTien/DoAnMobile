...
public class GiaiTri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.listViewGiaiTri);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(GiaiTri.this,NewsActivity.class);
    ...
    private class ReadRss extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customAdapter = new CustomAdapter(GiaiTri.this, android.R.layout.simple_list_item_1, arrayDocBao);
