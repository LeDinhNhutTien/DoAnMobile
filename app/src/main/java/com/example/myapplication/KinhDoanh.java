...
public class KinhDoanh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_card_business);

        lv = (ListView) findViewById(R.id.listViewCardBusiness);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(KinhDoanh.this,NewsActivity.class);
    ...
    private class ReadRss extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customAdapter = new CustomAdapter(KinhDoanh.this, android.R.layout.simple_list_item_1, arrayDocBao);
