...
public class Xe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.listViewXe);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(Xe.this,NewsActivity.class);
    ...
    private class ReadRss extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customAdapter = new CustomAdapter(Xe.this, android.R.layout.simple_list_item_1, arrayDocBao);
